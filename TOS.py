...
class Display:
    def __init__(self):
        ...
        self.level_map = Level(self.screen,WIDTH,HEIGHT,START_X,START_Y,BMODE)
        self.enemies = []
        ...
        self.enemies.append(Enemy(self.screen, self.level_map.tile_rects, self.level_map, 530, 210, self.level_map.hazardrects,self.level_map.boostrects))
    ...
    def draw(self,screen):
        ...
        if BMODE == True:
            self.screen.blit(self.player.img, (self.player.player_rect.x + SIZE, self.player.player_rect.y-20))  # SHOW VELOCITIES
            self.screen.blit(self.player.img2,(self.player.player_rect.x + SIZE, self.player.player_rect.y))  # SHOW VELOCITIES
            for enemy in self.enemies:
                self.screen.blit(enemy.img,(enemy.enemy_rect.x + 20, enemy.enemy_rect.y-20))  # SHOW VELOCITIES
                self.screen.blit(enemy.img2, (enemy.enemy_rect.x + 20, enemy.enemy_rect.y))  # SHOW VELOCITIES
